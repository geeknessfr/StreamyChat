...
> vont casser — c'est ce qu'est une bêta. Ce qui est livré aujourd'hui, lui, reste.

![La fenêtre de chat](images/chat.png)

*La fenêtre de chat. Les messages ci-dessus viennent d'une démonstration intégrée, pas d'une
vraie chaîne.*

![L'éditeur de thème](images/apparence.png)
...
simplement — regarde l'historique de ton antivirus avant de croire que le téléchargement a raté.
