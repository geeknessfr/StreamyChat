...
> it, sign in with Twitch, and read your chat. Things will change and some will break — that is
> what a beta is. Everything that ships today is here to stay.

![The chat window](images/chat.png)

*The chat window. The messages above come from a built-in demo, not from a real channel.*

![The theme editor](images/apparence.png)
...
software that judges by reputation. If it happens, the file will simply vanish — check your
